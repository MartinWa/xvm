{
      ...
      "extraFieldsLeft": [
        ...
        //{"x": 0, "y": 0, "bgColor": ${"../playersPanel.xc": "def.c1"}, "h": 24, "w": "{{hp-ratio:148}}", "alpha": "{{alive?20|0}}"},
        //2{"x": 0, "y": 0, "bgColor": "0xFFFFFF", "h": 24, "w": "{{hp-max:158}}", "alpha": "{{alive?20|0}}"},
        //2{"x": 0, "y": 0, "bgColor": ${"../playersPanel.xc": "def.c1"}, "h": 24, "w": "{{hp:158}}", "alpha": "{{alive?20|0}}"},
        //3{"x": 0, "y":  19 , "bgColor": "0xFFFFFF", "h":  5 , "w": "148", "alpha": "{{alive? 20|0}}"},
        //3{"x": 0, "y":  19 , "bgColor": ${"../playersPanel.xc": "def.c1"}, "h":  5 , "w": "{{hp-ratio:148}}", "alpha": "{{alive? 30|0}}"},
      ...
      "extraFieldsRight": [
        ...
        ${"../playersPanel.xc": "def.hpBar"},
        ${"../playersPanel.xc": "def.hp"},
        //{"x": 0, "y": 0, "bgColor": ${"../playersPanel.xc": "def.c2"}, "h": 24, "w": "{{hp-ratio:148}}", "alpha": "{{alive?30|0}}"},
        //2{"x": 0, "y": 0, "bgColor": "0xFFFFFF", "h": 24, "w": "{{hp-max:155}}", "alpha": "{{alive?20|0}}"},
        //2{"x": 0, "y": 0, "bgColor": ${"../playersPanel.xc": "def.c2"}, "h": 24, "w": "{{hp:155}}", "alpha": "{{alive?30|0}}"},
        //3{"x": 0, "y":  19 , "bgColor": "0xFFFFFF", "h":  5 , "w": "148", "alpha": "{{alive? 20|0}}"},
        //3{"x": 0, "y":  19 , "bgColor": ${"../playersPanel.xc": "def.c2"}, "h":  5 , "w": "{{hp-ratio:148}}", "alpha": "{{alive? 50|0}}"},
        //4{"x": 60, "y": 6, "align": "center", "valign": "top", "src": "xvm://res/icons/flags/{{flag|default}}.png", "alpha": "{{alive?100|30}}", "shadow": {} },
        {}
      ]
}